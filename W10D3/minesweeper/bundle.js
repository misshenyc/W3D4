...
var Board = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Board, [{
    ...
    value: function render() {
      ...
      var tiles = this.props.board.grid.map(function (row, idx) {
        var boardRow = row;
        var rowIdx = idx; // debugger

        var mappedRow = boardRow.map(function (piece, idx) {
          var tilePiece = piece;
          var pos = [rowIdx, idx];
          var keyValue = rowIdx * _this.props.board.gridSize + idx; // debugger

          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            key: keyValue
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_tile__WEBPACK_IMPORTED_MODULE_3__["default"], {
            tilePiece: tilePiece,
...
var Game = /*#__PURE__*/function (_React$Component) {
  ...
  function Game(props) {
    ...
    _this.state = {
      board: new _minesweeper__WEBPACK_IMPORTED_MODULE_2__["Board"](10, 22)
    };
  ...
  _createClass(Game, [{
    key: "updateGame",
    value: function updateGame(tilePiece, flag) {
      // debugger
      if (flag) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
        className: "gamename"
      }, " Minesweeper "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_board__WEBPACK_IMPORTED_MODULE_3__["default"], {
        board: this.state.board,
...
var Tile = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Tile, [{
    ...
    value: function render() {
      // debugger;
      var _this$props$tilePiece = this.props.tilePiece,
          flagged = _this$props$tilePiece.flagged,
          bombed = _this$props$tilePiece.bombed,
          explored = _this$props$tilePiece.explored;
      var tile = this.props.tilePiece; // const flagged = flagged ? 'flagged' : '';
      ...
      if (explored) {
        if (bombed) {
          ...
          var bombNum = tile.adjacentBombCount();
